...
{
	echo '<!-- <wiki-error>invalid page name</wiki-error> --><em class="error">'.sprintf(ERROR_INVALID_PAGENAME, $this->tag).'</em>';
}
...
{
	$message = '<!-- <wiki-error>forbidden</wiki-error> --><em class="error">'.$this->Format(ERROR_NO_WRITE_ACCESS).'</em><br />'."\n".
			"<br />\n".
