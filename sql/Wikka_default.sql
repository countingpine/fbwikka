...
--
-- Host: localhost    Database: wikka_132
-- ------------------------------------------------------
...
CREATE TABLE `wikka_users` (
  ...
  `default_comment_display` enum('date_asc','date_desc','threaded') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'threaded',
...
-- Dump completed on 2011-10-02 15:12:58
